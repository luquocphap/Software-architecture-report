...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\linewidth]{image/4.2.3.png}
    \caption{Component View}
    \label{fig:component-all}
\end{figure}

Sau khi hoàn thiện kiến trúc hệ thống, Component \& Connector View được tách thành nhiều sơ đồ nhỏ nhằm giúp mô tả rõ ràng hơn từng khía cạnh kỹ thuật của hệ thống thay vì gom toàn bộ thành phần vào một sơ đồ lớn duy nhất.

Cách tổ chức này giúp:
\begin{itemize}
    \item Giảm độ phức tạp của sơ đồ tổng thể.
    \item Giúp người đọc dễ theo dõi từng nhóm chức năng.
    \item Phân tách rõ business flow, persistence, event-driven communication và infrastructure.
    \item Tăng khả năng bảo trì và mở rộng tài liệu kiến trúc.
\end{itemize}

Các sơ đồ Component View được chia thành bốn nhóm chính gồm:
\begin{itemize}
    \item Core Business Flow Component View
    \item Event-Driven Component View
    \item Persistence Component View
    \item Infrastructure / Technical Component View
\end{itemize}
